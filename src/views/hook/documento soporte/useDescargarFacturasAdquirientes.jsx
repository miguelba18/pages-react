...
const useDescargarFacturasAdquirientes = () => {
    ...
    const handleDownloadExcel = async (ciudad, filtro,anio,tipo="adquirientes") => {
      ...
      if (tipoString) {
        ...
        try {
          ...
          const fileName = fileNameMatch ? fileNameMatch[1] : "datos_soportes_adquirientes.xlsx";
...
export default useDescargarFacturasAdquirientes
