...
const useDescargarConsorcios = () => {
    const { token } = useAuthToken();

    const handleDownloadExcel = async (filtro,anio) => {
      let url = `http://localhost:8080/consorcio/descargar-excel?filtro=${filtro}&anio=${anio}`;
        ...
        try {
          ...
          const fileName = fileNameMatch ? fileNameMatch[1] : "datos_consorcio.xlsx";
...
export default useDescargarConsorcios
