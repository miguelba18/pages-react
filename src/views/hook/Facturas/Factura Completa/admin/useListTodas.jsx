...
const useListTodas = () => {
  ...
  const fetchData = async (url,setter) => {
    try {
      ...
      console.error(`Error en fetchFacturas desde ${url}:`, error);
    }
  };
...
useEffect(() => {
  ...
  fetchDepartamentosEmisores
    ...
    const {
      ...
      return { totalSuma, facturas, departamentos, filteredCiudades, handleCiudadChange, handleDepartamentoChange, selectedCiudad, selectedDepartamento,setFacturas, fetchFacturas, selectedAnio, setSelectedAnio,nombresComerciales,
