...
const useListTodas = () => {
  ...
  const [numerosDocumentoAdquirientes, setNumerosDocumentoAdquirientes] =
    useState([]);
  ...
  const fetchNombresComerciales = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/nombreComercialEmisor",
        setNombresComerciales
      ),
    [token]
  );
  const fetchTelefonosAdquirientes = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/telefonoAdquiriente",
        setTelefonosAdquirientes
      ),
    [token]
  );
  const fetchCorreosAdquirientes = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/correoAdquiriente",
        setCorreosAdquirientes
      ),
    [token]
  );
  const fetchDireccionesAdquirientes = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/direccionAdquiriente",
        setDireccionesAdquirientes
      ),
    [token]
  );
  const fetchMunicipiosAdquirientes = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/municipioAdquiriente",
        setMunicipiosAdquirientes
      ),
    [token]
  );
  const fetchDepartamentosAdquirientes = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/departamentoAdquiriente",
        setDepartamentosAdquirientes
      ),
    [token]
  );
  const fetchNumerosDocumentoAdquirientes = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/numeroDocumentoAdquiriente",
        setNumerosDocumentoAdquirientes
      ),
    [token]
  );
  const fetchNombresAdquirientes = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/nombreAdquiriente",
        setNombresAdquirientes
      ),
    [token]
  );
  const fetchNitsEmisores = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/nitEmisor",
        setNitsEmisores
      ),
    [token]
  );
  const fetchTelefonosEmisores = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/telefonoEmisor",
        setTelefonosEmisores
      ),
    [token]
  );
  const fetchCorreosEmisores = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/correoEmisor",
        setCorreosEmisores
      ),
    [token]
  );
  const fetchDireccionesEmisores = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/direccionEmisor",
        setDireccionesEmisores
      ),
    [token]
  );
  const fetchMunicipiosEmisores = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/municipioEmisor",
        setMunicipiosEmisores
      ),
    [token]
  );
  const fetchDepartamentosEmisores = useCallback(
    () =>
      fetchData(
        "http://localhost:8080/facturatodas/listar/departamentoEmisor",
        setDepartamentosEmisores
      ),
