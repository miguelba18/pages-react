  ...
  return (
    <div className="overflow-auto">
      ...
      <div className="xl:relative mr-4">
          <button className="flex justify-center items-center gap-2 xl:gap-2 px-4 py-2 cursor-pointer rounded-md shadow-2xl text-white font-semibold bg-gradient-to-r from-[#78fb71] via-[#55e11d] to-[#12be1b] hover:shadow-xl hover:shadow-green-500 hover:scale-105 duration-300 hover:from-[#12be1b] hover:to-[#78fb71]">
      ...
      <h1 className="text-2xl font-bold mb-4 mt-4 xl:mt-0">Factura de Emisores</h1>
      ...
      <table className="table-auto w-full mt-8">
        <thead>
          <tr>
            ...
            <th className="px-4 py-2 bg-secundary text-white">Nombre o Razón Social del Emisor</th>
            <th className="px-4 py-2 bg-secundary text-white">Número Documento del Emisor</th>
            <th className="px-4 py-2 bg-secundary text-white">País del Emisor</th>
            <th className="px-4 py-2 bg-secundary text-white">Departamento del Emisor</th>
            <th className="px-4 py-2 bg-secundary text-white">Municipio del Emisor</th>
            <th className="px-4 py-2 bg-secundary text-white">Dirección del Emisor</th>
            <th className="px-4 py-2 bg-secundary text-white">Correo del Emisor</th>
