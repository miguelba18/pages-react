...
import useDescargarFacturasVendedores from "../../../../hook/documento soporte/useDescargarFacturasVendedores";

const DocumentoVendedorAlcalde = () => {
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 100;
  const [searchQuery, setSearchQuery] = useState("");
  const [selectedAnio, setSelectedAnio] = useState("");
  const { handleDownloadExcel } = useDescargarFacturasVendedores();
        ...
        <table className="table-auto w-full">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 bg-secundary text-white">Direccion</th>
          ...
          {facturas.length > 0 && (
            <tfoot>
              <tr>
                <th className="px-4 py-2 bg-secundary text-white" colSpan={11}>
                  Total
                </th>
...
export default DocumentoVendedorAlcalde;
