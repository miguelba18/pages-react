    ...
    <div className="overflow-auto">
      ...
      <div className="overflow-x-auto">
        <table className="table-auto w-full mt-8">
          ...
          <tbody>
            {searchQuery === ""
              ? facturas.map((adquiriente, index) => (
                  <tr key={adquiriente.id} className="whitespace-nowrap">
                    <td className="border px-4 py-2">{index + 1}</td>
                    <td className="border px-4">
                      {adquiriente.fechaEmision}
                    </td>
                    <td className="border px-4">
                      {adquiriente.nombreComercialEmisor}
                    </td>
                    <td className="border px-4 py-2">{adquiriente.nitEmisor}</td>
              ...
              : facturas.map((adquiriente, index) => (
                  <tr key={adquiriente.id} className="whitespace-nowrap">
                    <td className="border px-4 py-2">{index + 1}</td>
                    <td className="border px-4">
                      {adquiriente.fechaCreacion}
                    </td>
                    <td className="border px-4">
                      <HighlightedText
                        text={adquiriente.nombreComercialEmisor}
                        highlight={searchQuery}
                      />
                    </td>
                    <td className="border px-4 py-2">
                      <HighlightedText
                        text={adquiriente.nitEmisor}
                        highlight={searchQuery}
                      />
                    </td>
