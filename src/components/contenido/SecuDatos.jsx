    ...
    <section className=" min-h-[50vh] xl:min-h-[90vh] grid grid-cols-1 xl:grid-cols-8 ">           
                <div className=" md:col-span-4 flex items-center justify-center xl:pl-[22%] p-4 -mt-[18%]">
                    <div className="flex flex-col gap-6">
                        ...
                        <button className="flex mb-2 justify-center items-center gap-4 px-4 py-3 cursor-pointer rounded-md shadow-2xl text-white font-semibold bg-gradient-to-r from-primary via-[#45ede4] to-[#12bbb2] hover:shadow-xl hover:shadow-primary hover:scale-105 duration-300 hover:from-primary hover:to-[#04b3aa] ">
