      ...
      <div className="md:col-span-4 flex items-center justify-center xl:p-24 p-4">
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            <span className="text-[#FF432A] py-2 xl:px-6 border-8 border-[#FF432A] relative ml-4">
              SIM SAS
              <div className="hidden xl:inline">
                <RiCheckboxBlankCircleFill className="text-base absolute -left-5 -top-5 rounded-full text-white p-2 box-content bg-[#FF432A]" />
                <RiCheckboxBlankCircleFill className="text-base absolute -right-5 -top-5 rounded-full text-white p-2 box-content bg-[#FF432A]" />
                <RiCheckboxBlankCircleFill className="text-base absolute -left-5 -bottom-5 rounded-full text-white p-2 box-content bg-[#FF432A]" />
                <RiCheckboxBlankCircleFill className="text-base absolute -right-5 -bottom-5 rounded-full text-white p-2 box-content bg-[#FF432A]" />
              </div>
            </span>
          </h1>
